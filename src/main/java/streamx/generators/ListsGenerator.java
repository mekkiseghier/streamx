...
/**
 * Generates non-concurrent EntriesList classes (EntriesList1, EntriesList2, ...) using generic types T1, T2, ..., TN.
 */
public class ListsGenerator {

    public static void main(String[] args) {
        int max = 10; // You can increase this number to generate more classes
        for (int n = 1; n <= max; n++) {
            try {
                generate(n);
            } catch (IOException e) {
