...
/**
 * Represents a supplier of results that takes 5 element arguments
 ...
 */
@FunctionalInterface
public interface Supplier5<T1, T2, T3, T4, T5, R> {
    /**
     ...
     * @return the result
     */
    R get(int index, T1 v1, T2 v2, T3 v3, T4 v4, T5 v5);
}
