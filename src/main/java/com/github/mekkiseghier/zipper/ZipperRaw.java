 ...
 * </p>
 *
 * <p><b>Note:</b> Unlike {@code Zipper1} to {@code Zipper20}, this class does not enforce type safety.
 ...
 * ZipperRaw raw = new ZipperRaw(names, scores);
 * }</pre>
 */
public class ZipperRaw {

    private final List<List<?>> lists = new ArrayList<>();

    /**
     * Constructs a {@code ZipperRaw} instance by accepting a variable number of lists.
     ...
     */
    public ZipperRaw(List<?>... list) {
        lists.addAll(List.of(list));
    }
    /**
     * Adds a new array of elements to this {@link ZipperRaw}
    ...
    /**
     * Adds a new list to this {@link ZipperRaw}, producing a {@link ZipperRaw} that enables
