...
import com.github.mekkiseghier.zipper.accumulators.Accumulator14;
import com.github.mekkiseghier.zipper.consumers.Consumer14;
import com.github.mekkiseghier.zipper.functions.Function14;
import com.github.mekkiseghier.zipper.predicates.Predicate14;
import com.github.mekkiseghier.zipper.tuples.Tuple14;
 ...
 * <p>
 * {@code Zipper14} enables index-aware, type-safe, and readable iteration over 14 lists in parallel.
 ...
 *
 * <pre>{@code
 * Zipper14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> stream =
 *     Zipper.addLists(list1, list2, list3, list4, list5, list6, list7, list8, list9, list10, list11, list12, list13, list14);
 *
...
public class Zipper14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> {
    ...
    public Zipper14(List<T1> list1, List<T2> list2, List<T3> list3, List<T4> list4, List<T5> list5, List<T6> list6, List<T7> list7, List<T8> list8, List<T9> list9, List<T10> list10, List<T11> list11, List<T12> list12, List<T13> list13, List<T14> list14) {
    ...
    /**
     * Adds a new array of elements to this {@link Zipper14}, producing a {@link Zipper15}
     ...
     * @return a {@code Zipper15<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>} representing the parallel lists
     * @throws IllegalArgumentException if the number of elements does not match the existing size
     */
     @SafeVarargs    public final <T15> Zipper15 <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> addElements( T15... values) {
        ...
        return new Zipper15 <>(list1, list2, list3, list4, list5, list6, list7, list8, list9, list10, list11, list12, list13, list14, safeList);
    }


    /**
     * Adds a new list to this {@link Zipper14}, producing a {@link Zipper15} that enables
     ...
     */
    public <T15> Zipper15<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> addList(List<T15> list) {
        if (list.size() != size) {
            throw new IllegalArgumentException("List size mismatch");
        }
        return new Zipper15<>(list1, list2, list3, list4, list5, list6, list7, list8, list9, list10, list11, list12, list13, list14, list);
    }
     ...
     * @return a new {@code Zipper14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>} with filtered elements
     */
    public Zipper14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> filter(Predicate14<Integer, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> predicate) {
        ...
        return new Zipper14<>(filtered1, filtered2, filtered3, filtered4, filtered5, filtered6, filtered7, filtered8, filtered9, filtered10, filtered11, filtered12, filtered13, filtered14);
    }
    /**
     ...
     */
    public Zipper14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> peek(Consumer14<Integer, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> action) {
        for (int i = 0; i < list1.size(); i++) {
            action.accept(i, list1.get(i), list2.get(i), list3.get(i), list4.get(i), list5.get(i), list6.get(i), list7.get(i), list8.get(i), list9.get(i), list10.get(i), list11.get(i), list12.get(i), list13.get(i), list14.get(i));
        }
        return this;
