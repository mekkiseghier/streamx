...
/**
 * A tuple containing an index and 8 values.
...
public class Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> {
    ...
    /**
     * Creates a tuple with index and 8 values.
     ...
     */
    public Tuple8(int index, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8) {
        this.index = index;
        this.t1 = t1;
        this.t2 = t2;
        this.t3 = t3;
