...
/**
 * Represents a predicate (boolean-valued function) that tests 6 values
 ...
 */
@FunctionalInterface
public interface Predicate6<I, T1, T2, T3, T4, T5, T6> {
     ...
     */
    boolean test(I index, T1 v1, T2 v2, T3 v3, T4 v4, T5 v5, T6 v6);
}
