...
/**
 * Represents a predicate (boolean-valued function) that tests 8 values
 ...
 */
@FunctionalInterface
public interface Predicate8<I, T1, T2, T3, T4, T5, T6, T7, T8> {
     ...
     * @param v8 the eighth value to test
     * @return {@code true} if the input matches the predicate, otherwise {@code false}
     */
    boolean test(I index, T1 v1, T2 v2, T3 v3, T4 v4, T5 v5, T6 v6, T7 v7, T8 v8);
}
