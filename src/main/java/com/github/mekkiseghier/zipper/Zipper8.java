...
import com.github.mekkiseghier.zipper.accumulators.Accumulator8;
import com.github.mekkiseghier.zipper.consumers.Consumer8;
import com.github.mekkiseghier.zipper.functions.Function8;
import com.github.mekkiseghier.zipper.predicates.Predicate8;
import com.github.mekkiseghier.zipper.tuples.Tuple8;
...
public class Zipper8<T1, T2, T3, T4, T5, T6, T7, T8> {
    ...
    public Zipper8(List<T1> list1, List<T2> list2, List<T3> list3, List<T4> list4, List<T5> list5, List<T6> list6, List<T7> list7, List<T8> list8) {
    ...
    public Zipper8<T1, T2, T3, T4, T5, T6, T7, T8> filter8(Predicate8<Integer, T1, T2, T3, T4, T5, T6, T7, T8> predicate) {
        ...
        return new Zipper8<>(filtered1, filtered2, filtered3, filtered4, filtered5, filtered6, filtered7, filtered8);
    }
    /**
