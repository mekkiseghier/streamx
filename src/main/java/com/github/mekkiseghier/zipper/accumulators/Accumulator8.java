...
/**
 * Represents an operation that combines an index and 8 arguments into a single result.
 * This is a functional interface
 * whose functional method is {@link #reduce(Object, Object, Object, Object, Object, Object, Object, Object, Object)}.
 *
 ...
 */
@FunctionalInterface
public interface Accumulator8<I, T1, T2, T3, T4, T5, T6, T7, T8, R> {
     ...
     */
    R reduce(I index, T1 v1, T2 v2, T3 v3, T4 v4, T5 v5, T6 v6, T7 v7, T8 v8);
}
