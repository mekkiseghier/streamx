 ...
 * <p>
 * {@code StreamX4} enables index-aware, type-safe, and readable iteration over 4 lists in parallel.
 ...
 *
 * <pre>{@code
 * StreamX4<T1, T2, T3, T4> stream =
 *     StreamX.addLists(list1, list2, list3, list4);
 *
...
public class StreamX4<T1, T2, T3, T4> {
    ...
    /**
     * Adds a new array of elements to this {@link StreamX4}, producing a {@link StreamX5}
     ...
     * @return a {@code StreamX5<T1, T2, T3, T4, T5>} representing the parallel lists
     * @throws IllegalArgumentException if the number of elements does not match the existing size
     */

     @SafeVarargs    public final <T5> StreamX5 <T1, T2, T3, T4, T5> addElements( T5... values) {
    ...
    /**
     * Adds a new list to this {@link StreamX4}, producing a {@link StreamX5} that enables
     ...
     */
    public <T5> StreamX5<T1, T2, T3, T4, T5> addList(List<T5> list) {
        if (list.size() != size) {
            throw new IllegalArgumentException("List size mismatch");
        }
        return new StreamX5<>(list1, list2, list3, list4, list);
    }
     ...
     * @return a new {@code StreamX4<T1, T2, T3, T4>} with filtered elements
     */
