...
import com.github.mekkiseghier.streamx.accumulators.Accumulator11;
import com.github.mekkiseghier.streamx.consumers.Consumer11;
import com.github.mekkiseghier.streamx.functions.Function11;
import com.github.mekkiseghier.streamx.predicates.Predicate11;
import com.github.mekkiseghier.streamx.tuples.Tuple11;
 ...
 * <p>
 * {@code StreamX11} enables index-aware, type-safe, and readable iteration over 11 lists in parallel.
 ...
 *
 * <pre>{@code
 * StreamX11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> stream =
 *     StreamX.addLists(list1, list2, list3, list4, list5, list6, list7, list8, list9, list10, list11);
 *
...
public class StreamX11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> {
    ...
    public StreamX11(List<T1> list1, List<T2> list2, List<T3> list3, List<T4> list4, List<T5> list5, List<T6> list6, List<T7> list7, List<T8> list8, List<T9> list9, List<T10> list10, List<T11> list11) {
    ...
    /**
     * Adds a new array of elements to this {@link StreamX11}, producing a {@link StreamX12}
     ...
     * @return a {@code StreamX12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>} representing the parallel lists
     * @throws IllegalArgumentException if the number of elements does not match the existing size
     */
     @SafeVarargs    public final <T12> StreamX12 <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> addElements( T12... values) {
        ...
        return new StreamX12 <>(list1, list2, list3, list4, list5, list6, list7, list8, list9, list10, list11, safeList);
    }


    /**
     * Adds a new list to this {@link StreamX11}, producing a {@link StreamX12} that enables
     ...
     */
    public <T12> StreamX12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> addList(List<T12> list) {
        if (list.size() != size) {
            throw new IllegalArgumentException("List size mismatch");
        }
        return new StreamX12<>(list1, list2, list3, list4, list5, list6, list7, list8, list9, list10, list11, list);
    }
     ...
     * @return a new {@code StreamX11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>} with filtered elements
     */
    public StreamX11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> filter(Predicate11<Integer, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> predicate) {
        ...
        return new StreamX11<>(filtered1, filtered2, filtered3, filtered4, filtered5, filtered6, filtered7, filtered8, filtered9, filtered10, filtered11);
    }
    /**
     ...
     */
    public StreamX11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> peek(Consumer11<Integer, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> action) {
        for (int i = 0; i < list1.size(); i++) {
            action.accept(i, list1.get(i), list2.get(i), list3.get(i), list4.get(i), list5.get(i), list6.get(i), list7.get(i), list8.get(i), list9.get(i), list10.get(i), list11.get(i));
        }
        return this;
