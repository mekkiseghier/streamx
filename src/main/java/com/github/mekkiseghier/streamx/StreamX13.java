 ...
 * <p>
 * {@code StreamX13} enables index-aware, type-safe, and readable iteration over 13 lists in parallel.
 ...
 *
 * <pre>{@code
 * StreamX13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> stream =
 *     StreamX.addLists(list1, list2, list3, list4, list5, list6, list7, list8, list9, list10, list11, list12, list13);
 *
...
public class StreamX13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> {
    ...
    /**
     * Adds a new array of elements to this {@link StreamX13}, producing a {@link StreamX14}
     ...
     * @return a {@code StreamX14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>} representing the parallel lists
     * @throws IllegalArgumentException if the number of elements does not match the existing size
     */
     @SafeVarargs    public final <T14> StreamX14 <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> addElements( T14... values) {
    ...
    /**
     * Adds a new list to this {@link StreamX13}, producing a {@link StreamX14} that enables
     ...
     */
    public <T14> StreamX14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> addList(List<T14> list) {
        if (list.size() != size) {
            throw new IllegalArgumentException("List size mismatch");
        }
        return new StreamX14<>(list1, list2, list3, list4, list5, list6, list7, list8, list9, list10, list11, list12, list13, list);
    }
     ...
     * @return a new {@code StreamX13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>} with filtered elements
     */
