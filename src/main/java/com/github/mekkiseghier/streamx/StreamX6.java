 ...
 * <p>
 * {@code StreamX6} enables index-aware, type-safe, and readable iteration over 6 lists in parallel.
 ...
 *
 * <pre>{@code
 * StreamX6<T1, T2, T3, T4, T5, T6> stream =
 *     StreamX.addLists(list1, list2, list3, list4, list5, list6);
 *
...
public class StreamX6<T1, T2, T3, T4, T5, T6> {
    ...
    /**
     * Adds a new array of elements to this {@link StreamX6}, producing a {@link StreamX7}
     ...
     * @return a {@code StreamX7<T1, T2, T3, T4, T5, T6, T7>} representing the parallel lists
     * @throws IllegalArgumentException if the number of elements does not match the existing size
     */
     @SafeVarargs    public final <T7> StreamX7 <T1, T2, T3, T4, T5, T6, T7> addElements( T7... values) {
    ...
    /**
     * Adds a new list to this {@link StreamX6}, producing a {@link StreamX7} that enables
     ...
     */
    public <T7> StreamX7<T1, T2, T3, T4, T5, T6, T7> addList(List<T7> list) {
        if (list.size() != size) {
            throw new IllegalArgumentException("List size mismatch");
        }
        return new StreamX7<>(list1, list2, list3, list4, list5, list6, list);
    }
     ...
     * @return a new {@code StreamX6<T1, T2, T3, T4, T5, T6>} with filtered elements
     */
