...
import com.github.mekkiseghier.streamx.accumulators.Accumulator10;
import com.github.mekkiseghier.streamx.consumers.Consumer10;
import com.github.mekkiseghier.streamx.functions.Function10;
import com.github.mekkiseghier.streamx.predicates.Predicate10;
import com.github.mekkiseghier.streamx.tuples.Tuple10;
...
public class StreamX10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> {
    ...
    public StreamX10(List<T1> list1, List<T2> list2, List<T3> list3, List<T4> list4, List<T5> list5, List<T6> list6, List<T7> list7, List<T8> list8, List<T9> list9, List<T10> list10) {
